...
export function formatAnalysis(
	...
	switch (resolved) {
		...
		case "html":
			return formatAnalysisHtml(result);
		case "terminal":
...
export function formatComparison(
	...
	switch (resolved) {
		case "json":
			return formatComparisonJson(result);
		case "markdown":
			return formatComparisonMarkdown(result);
		case "html":
			return formatComparisonMarkdown(result);
		case "terminal":
			return formatComparisonTerminal(result);
	}
}
...
export function formatBatch(
	...
	switch (resolved) {
		...
		case "markdown":
			return formatBatchMarkdown(result);
		case "html":
			return formatBatchHtml(result);
		case "terminal":
			return formatBatchTerminal(result);
	}
}
