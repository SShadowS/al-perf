...
/**
 * Render per-finding SQL evidence. Two provenances, never conflated: sampled
 * profile estimates (NEVER "measured"/"exact"/"ran N times") or measured
 * threshold-gated telemetry (NEVER "sampled"). Up to 5 statement lines.
 */
