...
((g, f) => {
	...
	function () {
		...
		var Se = (l) => Pe(H({}, "__esModule", { value: !0 }), l);
		var Tt = {};
		ye(Tt, {
			Hooks: () => P,
			Lexer: () => x,
		...
		var $e = (() => {
			...
			We = k(ce, "u").replace(/punct/g, v).getRegex(),
			Xe = k(ce, "u").replace(/punct/g, ue).getRegex(),
			he =
			...
			B = { normal: K, gfm: qe, pedantic: ve },
			z = { normal: X, gfm: N, breaks: pt, pedantic: ut };
		var ct = {
				"&": "&amp;",
				"<": "&lt;",
				">": "&gt;",
		...
		function V(l, e) {
			let t = l.replace(m.findPipe, (_i, s, a) => {
					let o = !1,
						u = s;
					for (; --u >= 0 && a[u] === "\\"; ) o = !o;
					return o ? "|" : " |";
...
`),
								$ = this.blockquote(f);
							(s[s.length - 1] = $),
								(r = r.substring(0, r.length - T.raw.length) + $.raw),
								(i = i.substring(0, i.length - T.text.length) + $.text);
							break;
						} else if (h?.type === "list") {
							const T = h,
								f =
...
`),
								$ = this.list(f);
							(s[s.length - 1] = $),
								(r = r.substring(0, r.length - h.raw.length) + $.raw),
								(i = i.substring(0, i.length - T.raw.length) + $.raw),
					...
					for (const u of i.items) {
						if (
							...
							if (
								...
								u.tokens[0]?.type === "text" ||
									u.tokens[0]?.type === "paragraph")
							) {
							...
							const p = this.rules.other.listTaskCheckbox.exec(u.raw);
							if (p) {
								const c = {
									type: "checkbox",
									raw: p[0] + " ",
						...
						if (!i.loose) {
							const p = u.tokens.filter((d) => d.type === "space"),
								c =
									p.length > 0 &&
...
`
				...
				if (t) {
					...
					return (
						...
						xe(
							t,
							{
								href: r?.replace(this.rules.inline.anyPunctuation, "$1"),
								title: i?.replace(this.rules.inline.anyPunctuation, "$1"),
							},
							t[0],
							this.lexer,
							this.rules,
		...
		var x = class l {
			...
			constructor(e) {
				...
				const t = { other: m, block: B.normal, inline: z.normal };
				this.options.pedantic
					? ((t.block = B.pedantic), (t.inline = z.pedantic))
					: this.options.gfm &&
						((t.block = B.gfm),
									...
									: (i[a] = (...p) => {
											if (this.defaults.async)
												return (async () => {
													...
													return d === !1 && (d = await u.apply(i, p)), d;
												})();
											let c = o.apply(i, p);
											return c === !1 && (c = u.apply(i, p)), c;
										});
...
Please report this to https://github.com/markedjs/marked.`),
		...
		g.options = g.setOptions = (l) => (
			M.setOptions(l), (g.defaults = M.defaults), Z(g.defaults), g
		);
		g.getDefaults = _;
		g.defaults = R;
		g.use = (...l) => (
			M.use(...l), (g.defaults = M.defaults), Z(g.defaults), g
		);
