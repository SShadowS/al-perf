...
const sampleFindings: AIFinding[] = [
	{
		...
		confidence: "high",
		description:
			"Multiple methods fetch the same Customer record without caching.",
...
const sampleNarrative =
	"This profile reveals two main concerns: redundant record fetching and an anomalous spike in insert operations.";
